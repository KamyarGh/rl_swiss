...
class VAE(nn.Module):
    def __init__(
        ...
        self.z_mean_conv = nn.Conv2d(inter_ch, z_ch, 3, stride=1, padding=1, bias=True)
        self.z_log_cov_conv = nn.Conv2d(inter_ch, z_ch, 3, stride=1, padding=1, bias=True)        
    ...
    def forward(self, obs_batch):
        ...
        return recon_mean, recon_log_cov, z_mean, z_log_cov
