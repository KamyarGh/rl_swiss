...
MAX_PATH_LENGTH = 65
EXPERT_BUFFER_PATH = '/scratch/gobi2/kamyar/oorl_rlkit/expert_demos/faster_few_shot_fetch_eval_expert_trajs/extra_data.pkl'
...
if __name__ == '__main__':
    ...
    joblib.dump({'faster_all_eval_stats': all_stats}, osp.join(args.path, 'faster_all_eval_stats.pkl'), compress=3)
