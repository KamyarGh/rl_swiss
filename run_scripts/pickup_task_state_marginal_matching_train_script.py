...
from rlkit.state_matching_algs.pickup_task_state_marginal_matching_alg import PickupTaskStateMarginalMatchingAlg


def experiment(variant):
    expert_buffer = joblib.load(variant['data_path'])['data']
    ...
    alg_class = PickupTaskStateMarginalMatchingAlg
    algorithm = alg_class(
        env,
        policy,
        disc_model,
