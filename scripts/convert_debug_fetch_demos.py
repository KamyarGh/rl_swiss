...
# get the original
her_demos_path = '/ais/gobi6/kamyar/oorl_rlkit/expert_demos/her_fetch_pick_and_place/debug_fetch_reach/data_for_debug_fetch_reach_random_100.npz'
rlkit_buffer_save_dir = '/ais/gobi6/kamyar/oorl_rlkit/expert_demos/her_fetch_pick_and_place/debug_fetch_reach/'
...
for path_num in range(len(d['obs'])):
    ...
    for j in range(ep_len-1):
        o = {
            ...
            'obs_task_params': obs[j]['observation'][3:6]
        }
        a = acs[j]
        ...
        next_o = {
            ...
            'obs_task_params': obs[j+1]['observation'][3:6]
        }
